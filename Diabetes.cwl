...
steps:
  ...
  diabetes-check---primary:
    run: diabetes-check---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  nonketotic-diabetes---primary:
    run: nonketotic-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-attack---primary:
    run: diabetes-attack---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  advanced-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-attack---primary/output
  ...
  diabetes-nurse---primary:
    run: diabetes-nurse---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-pregnancy---primary:
    run: diabetes-pregnancy---primary.cwl
    out:
    - output
    in:
      inputModule:
